...
int main()
{
    ...
    if(strcmp(a,c1) == 0){
        ...
        if(strcmp(b,c11) == 0){
            scanf("%s",c);
            if(strcmp(c,c111) == 0) printf("%s\n",a1);
            else if(strcmp(c,c112) == 0) printf("%s\n",a2);
        }
        else if(strcmp(b,c12) == 0){
            scanf("%s",c);
            if(strcmp(c,c112) == 0) printf("%s\n",a3);
            else if(strcmp(c,c124) == 0) printf("%s\n",a4);
        }
    }
        ...
        if(strcmp(b,c21) == 0){
            scanf("%s",c);
            if(strcmp(c,c211) == 0) printf("%s\n",a5);
            else if(strcmp(c,c124) == 0) printf("%s\n",a6);
        }
        else if(strcmp(b,c22) == 0){
            scanf("%s",c);
            if(strcmp(c,c211) == 0) printf("%s\n",a7);
            else if(strcmp(c,c112) == 0) printf("%s\n",a8);
        }
